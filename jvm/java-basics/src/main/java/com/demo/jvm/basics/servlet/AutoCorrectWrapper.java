package com.demo.jvm.basics.servlet;
...
/** Created by xialei on 16/5/29. */
public class AutoCorrectWrapper extends HttpServletRequestWrapper {
  public AutoCorrectWrapper(HttpServletRequest request) {
    super(request);
  }
  ...
  public String getParameter(String name) {
    return "CorrectPrefix: " + super.getParameter(name);
  }
